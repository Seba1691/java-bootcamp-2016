...
/**
 * This class is responsible for creating the appropriate shopping service
...
public class ShoppingCartServiceFactory {
	 ...
	 * ShoppingCartService interface in order to be created by the factory.
	 */
	...
	/**
	 * This method returns the right ShoppingCartService implementation based on
	 * the ShoppingCartServiceType that it gets by parameter.
	 * 
	 * @param type
	...
	public static ShoppingCartService getShoppingCartService(ShoppingCartServiceTypes type) {
		if (type.equals(ShoppingCartServiceTypes.DATABASEIMP)) {
